...
class HistorialUso(Base):
    ...
    calificacion = Column("Calificación", Integer, nullable=True)  # Calificación de 1 a 5 estrellas
    descripcion_calificacion = Column("Descripcion_calificacion", Text, nullable=True)  # Descripción de la calificación
